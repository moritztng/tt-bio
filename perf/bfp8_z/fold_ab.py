...
REGION_COUNTERS = [
    ...
    ("REBLOCK_PERMUTE", "tt_bio.reblock_permute", "STATS", "REJECTS"),
    ("REBLOCK_PERMUTE_BACK", "tt_bio.reblock_permute", "STATS_BACK", None),
    ("REBLOCK_PERMUTE_GATED", "tt_bio.reblock_permute", "STATS_GATED", None),
    ("PAIR_Z_B8", "tt_bio.tenstorrent", "PAIR_Z_B8_STATS", None),
    ("TRIMUL_GOUT", "tt_bio.tenstorrent", "TRIMUL_GOUT_STATS", None),
    ("RESIDUAL_L1", "tt_bio.tenstorrent", "RESIDUAL_L1_STATS", None),
]
...
def worker(args) -> int:
    ...
    work = Path(tempfile.mkdtemp(prefix="bfp8z-", dir=str(REPO / "perf" / "bfp8_z")))
...
def main() -> int:
    ...
    ap.add_argument("--flag", default="TT_BIO_PAIR_Z_B8", choices=sorted(FLAGS))
