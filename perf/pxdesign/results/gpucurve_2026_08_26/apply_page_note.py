...
def main():
    ...
    row = (
        ...
        "arithmetic and not capacity, and capping the internal chunk at %d holds the batch-of-%d "
        "rate for a request of any size. The same lever is worth %sx at %d on the H200 and %sx at %d "
