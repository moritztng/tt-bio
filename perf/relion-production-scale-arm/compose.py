...
QB1={4452:(186.48,176.344),13356:(662.39,643.288),35616:(1772.23,1737.06),111300:(5538.57,5428.22)}
CS={4452:[.9052,.9083,.9073],13356:[.9100,.9064,.9080],35616:[.9076,.9095,.9073],111300:[.9078,.9092,.9072,.9090]}
...
DEV=9.37
rows={}
for N,sw in ((4452,m(CS[4452])*e6w[4452]),(111300,m(CS[111300])*e6w[111300])):
