...
Written by `recorder.py` at 2026-09-21T13:54:50Z.
...
the clock. An arm with a marker whose rc is not 0 is FAILED, not finished.
    ...
    zero           2/20  RUNNING         33 s  
    theirs         2/20  RUNNING        405 s  
...
Live `trajwide.py` processes:
    ...
    26520 /home/ttuser/tt-bio-dev/env/bin/python perf/of3t_trajwide/trajwide.py --side theirs --arm theirs --threads 10 --aa-in-process
