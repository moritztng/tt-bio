...
Written by `recorder.py` at 2026-09-21T15:04:41Z.
...
the clock. An arm with a marker whose rc is not 0 is FAILED, not finished.
    ...
    shipped       20/20  COMPLETE      1238 s  arm=shipped rc=0 card=1 at=2026-09-21T14:44:02Z
    shipped_aa2    7/20  RUNNING         82 s  
    permute        0/20  not started   None s  
    stale          4/20  RUNNING        119 s  
    norebind      20/20  COMPLETE       697 s  arm=norebind rc=0 card=0 at=2026-09-21T14:53:04Z
    zero          20/20  COMPLETE      1260 s  arm=zero rc=0 card=0 at=2026-09-21T14:43:41Z
    theirs         9/20  RUNNING        137 s  
...
Live `trajwide.py` processes:
    ...
    122458 bash -c cd /home/ttuser/.coworker/wt/of3t-trajwide && for a in zero norebind stale; do echo "### $a"; OMP_NUM_THREADS=1 nice -n 19 /home/ttuser/tt-bio-dev/env/bin/python perf/of3t_trajwide/trajwide.py --score --arm $a --w0 own --threads 1 --out /tmp/of3t/trajwide/partial_${a}_k8.json > /tmp/of3t/trajwide/score_$a.log 2>&1; echo "$a rc=$?"; done
    122459 /home/ttuser/tt-bio-dev/env/bin/python perf/of3t_trajwide/trajwide.py --score --arm zero --w0 own --threads 1 --out /tmp/of3t/trajwide/partial_zero_k8.json
