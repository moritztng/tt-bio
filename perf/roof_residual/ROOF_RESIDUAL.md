...
Three rows rest on a child frame that ran to the end of its capture (`DiffusionTransformer|1x140x32x128,1x140x32x128`, `Diffusion|1x4480x3,1`, `MSALayer|1x512x512x128,1x1024x512x64`), so their op lists are a floor, not a count: a child that closes late takes the parent's next ops with it, never the reverse.
