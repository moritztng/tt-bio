...
SHAPES = [
    # (label, M, K, N)  -- 298 aa unless noted
    ("pair proj c_z 102400x128@128x128", 102400, 128, 128),
    ("pair trans up 102400x128@128x512", 102400, 128, 512),
    ("pair trans down 102400x512@512x128", 102400, 512, 128),
    ("trimul in 102400x128@128x256", 102400, 128, 256),
    ("trimul out 102400x256@256x256", 102400, 256, 256),
    ("pair->bias nt1 102400x128@128x32", 102400, 128, 32),
    ("117 pair trimul 16384x256@256x256", 16384, 256, 256),
    ("117 pair trans down 16384x512@512x128", 16384, 512, 128),
    ("atom proj 4480x128@128x128", 4480, 128, 128),
    ("atom trans up 4480x128@128x512", 4480, 128, 512),
    ("117 atom proj 1792x128@128x128", 1792, 128, 128),
    ("single proj 320x768@768x768", 320, 768, 768),
    ("single trans up 320x768@768x3072", 320, 768, 3072),
    ("single trans down 320x3072@3072x768", 320, 3072, 768),
    ("117 single proj 128x768@768x768", 128, 768, 768),
]
