...
SHAPES = [
    # The two DiT block shapes protenix.py:1091 actually runs in a 298 aa opendde fold, read off
    # perf/inblockw/census.py: 576 of the 607 firing protenix.py calls at 8 sampling steps, 14485
    # per production fold at 200 steps. mt = 19, so both are in the 2D mt <= 32 band.
    ("opendde DiT up   608x768@768x1536", 608, 768, 1536),
    ("opendde DiT down 608x1536@1536x768", 608, 1536, 768),
]
