#!/usr/bin/env python3
"""of3t-stackexact pairdiff.py with of3t-stackship's arm reports added to the lookup. Two trunk arms against each other, in one metric, so a floor and a separation sit side by side.
...
ARM_REPORTS = ("perf/of3t_stackship/DEV_*.json", "perf/of3t_stackexact/DEV_*.json", "perf/of3t_modelever/DEV_*.json", "perf/of3t_recut/DEV_RENORM_MODEL_N384_*.json")
