#!/usr/bin/env bash
# of3t-verbinstall: one trunk-gradient arm at crop 384 on qb1 card 0 (fanned out; card 1 holds PKG_HF3), softmax from the package.
...
SMX=$W/perf/of3t_verbinstall/SUPPRESS_${TAG}.json
...
echo -n "AICLK during (card 0, p150a Blackhole, qb1, MHz): "
