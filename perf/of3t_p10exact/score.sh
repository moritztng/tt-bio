...
#
#   score.sh <TAG> <trunk.pt>     -> perf/of3t_p10exact/MODEL_<TAG>_composed3660_n384.json
#                                    perf/of3t_p10exact/CLAUSE_<TAG>.json
set -uo pipefail
...
OUT=perf/of3t_p10exact/MODEL_${TAG}_composed3660_n384.json
...
"$PY" perf/of3t_modelframe/clause.py \
  ...
  --rescored "$OUT" --out "perf/of3t_p10exact/CLAUSE_${TAG}.json"
