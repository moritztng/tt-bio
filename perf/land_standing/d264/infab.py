#!/usr/bin/env python3
"""of3t-ieatom: inference before/after D263 + D264, from firing and digest (of3t-stackship infab.py).
...
MODELS = {
    "boltz2": {"kind": "predict", "model": "boltz2", "fixture": "perf/size512/fixtures/cdk2x2_128.yaml"},
