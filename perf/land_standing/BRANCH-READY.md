...
is exactly the tree the suite below scored.
    ...
    verified tree   17384ad44dd6742a23347b879b4bd0f5d274af5d  (commit a35180a7c)
    full suite      4723 passed, 282 skipped, 0 failed in 528.74 s, tree hash read after the run
    tip             one commit later, adding 30 lines to DIVIDING-K-VERDICT.md and nothing else,
                    so the suite result above covers every line of code on the branch
    guards on tip   837 passed, 35 skipped, 0 failed
    re-verified     2026-09-26, after merging main forward twice; the earlier 4722-pass run was
                    against a tree several main merges stale and no longer described this branch
