#!/bin/bash
# Byte-cap verification wave (02189d828): the two red od cells on the fixed code.
# Chips 3/5 are free (run3 finished there); 1/2 run od_9ivj/od_9q7y, 12/13 seednoise.
set -u
H=$HOME/mthuening
B=$H/oomfix_run4
