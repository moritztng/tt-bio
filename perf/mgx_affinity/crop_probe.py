...
"""The pocket crop Nesso-1 picks after its first trunk pass, device or CPU, same featurization.
    ...
    crop_probe.py <input.yaml> <out.json> [--cpu] [--seed N] [--force <crop.json> | --score]
...
--score keeps this run's own crop and scores to the end: a reference that also records its crop.
"""
import argparse
import json
import sys
...
if forced is not None or a.score:
