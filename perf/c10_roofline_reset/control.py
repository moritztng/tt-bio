...
def main():
    ...
    try:
        ...
        result = {
            ...
            'metal_source_head': Path('/home/ttuser/tt-metal-b2z/.git/HEAD').read_text().strip(),
        ...
        result['verdict'] = 'PASS' if result['flops_exact'] and result['bytes_exact'] else 'INSTRUMENT_UNFIT'
