...
**1.19-2.25 GB/s — VOID, see `of3t-xroof`**: those came off `bwprof.py`'s `gb` column, which bills
both ends of a crossing and undersizes fp32 by 2x. The measured rates are `to_device` **14.20 GB/s**
(90.2 % of Gen4 x8's raw 15.75) with the **host tile-shuffle** binding at untilize 4.13 / tilize
6.59 GB/s. Raw link bandwidth is still not what binds
them.
