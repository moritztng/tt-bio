...
twenty-one rows dispatched; `state/concluded` holds **one hundred twenty-one** of3t files, two of them
this row's own historical markers, so **one hundred nineteen rows have concluded**.
