...
LEDGER: `~/.coworker/state/of3t/LEDGER.md`, **R1-R195 and K1-K19**. **This field is an INDEX, not
...
GAP: **Pass 415: D58 is CLOSED and D250 is new and USER-FACING** — `msa_module`'s forward is 3.54x less accurate than upstream 0.4.3 bf16 (8.176e-03 against 2.311e-03); `of3t-msafwd` bisects it. The clause is at 1.3037867474869442x with the exact softmax on and `of3t-stackexact` asks whether a second component composes. Earlier: GAP: **New at pass 386, and it is a gap between a measurement and a shippable thing rather than
...
**Counts** (`stamp_row_counts.py`): 129 dispatched; `state/concluded` holds
**one hundred twenty-eight** of3t files, two this row's own markers, so **126 concluded**.
