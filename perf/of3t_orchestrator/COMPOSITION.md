...
Composed 2026-09-21 14:21:15Z from `origin/main` at `56ad6c0e0`.
Head `b5fe13c6d`, **2200 commits ahead**,
...
| `of3t-trajwide` | `43c149326` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 1945 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2041 files changed, 2860986 insertions(+), 313 deletions(-).
