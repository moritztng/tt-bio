...
Composed 2026-09-21 03:24:48Z from `origin/main` at `11a92f686`.
Head `b624f8b62`, **1526 commits ahead**,
carrying **54 of 56 rows**.
...
| `of3t-permalign` | *dispatched, no branch yet* | — |
| `of3t-rankunify` | *dispatched, no branch yet* | — |
| `of3t-rebind` | `96adb9797` | `perf/of3t_orchestrator/audit_evidence.py`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/d56restate/D56_RESTATED.json`,`perf/of3t_orchestrator/d56restate/restate_d56.py` `perf/of3t_orchestrator/d8restate/D8_RESTATED.json`,`perf/of3t_orchestrator/d8restate/restate_d8.py` `perf/of3t_orchestrator/defecttriage/triage.py`,`perf/of3t_orchestrator/record/DEFECTS.md` `perf/of3t_orchestrator/record/ORCHESTRATOR.md`,`tests/test_training_tape_rebind.py` `tt_bio/autograd.py` |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1916 insertions(+) 185 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1641 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1721 files changed, 2465244 insertions(+), 214 deletions(-).
