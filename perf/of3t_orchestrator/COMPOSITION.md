...
Composed 2026-09-21 01:05:21Z from `origin/main` at `97baf5025`.
Head `4799db324`, **1382 commits ahead**,
carrying **50 of 51 rows**.
...
| `of3t-f64softmax` | `d69a099ba` | `docs/training.md`,`perf/of3t_diffusion/device_gradient.py` `tt_bio/tenstorrent.py` |
...
| `of3t-theirtest` | *dispatched, no branch yet* | — |
...
| `of3t-wholemodel` | `97cce0c58` | `perf/of3t_orchestrator/assert_new_levers_default_off.py`,`perf/of3t_orchestrator/bondcov/BOND_COVERAGE_CANDIDATES.md` `perf/of3t_orchestrator/bondcov/BOND_PREDICATE_CANDIDATES.json`,`perf/of3t_orchestrator/bondcov/check_predicate.py` `perf/of3t_orchestrator/bondcov/.gitignore`,`perf/of3t_orchestrator/compose_verify.sh` `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/crop640/CROP_640_768_BYTE_BUDGET.json` `perf/of3t_orchestrator/fp32ceiling/FP32_CEILING_TRIAGE.json`,`perf/of3t_orchestrator/record/DEFECTS.md` `perf/of3t_orchestrator/record/ORCHESTRATOR.md` |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1866 insertions(+) 176 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1571 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1650 files changed, 2325451 insertions(+), 205 deletions(-).
