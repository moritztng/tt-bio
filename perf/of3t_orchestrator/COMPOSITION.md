...
Composed 2026-09-21 13:16:27Z from `origin/main` at `56ad6c0e0`.
Head `a3daf4846`, **2099 commits ahead**,
carrying **72 of 74 rows**.
...
| `of3t-d137ab` | `fe2e31df0` | `perf/of3t_orchestrator/assert_new_levers_default_off.py`,`perf/of3t_orchestrator/assert_one_flag_one_default.py` `perf/of3t_orchestrator/compose_verify.sh`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/defecttriage/triage.py`,`perf/of3t_orchestrator/record/DEFECTS.md` `perf/of3t_orchestrator/record/ORCHESTRATOR.md` |
| `of3t-d137-tapegate` | `46be7a238` | none outside its own `perf/of3t_d137-tapegate/` |
| `of3t-d56-renorm` | `fc3231ef3` | `docs/training.md`,`perf/of3t_d56renorm/BLAST_CONTROL_sitesoff.json` `perf/of3t_d56renorm/BLAST_RADIUS_noctrl.json`,`perf/of3t_d56renorm/BLAST_RADIUS_renorm.json` `perf/of3t_d56renorm/probe_sitecustomize.py`,`perf/of3t_d56renorm/renorm_blast_radius.py` `perf/of3t_d56renorm/renorm_step_cost.py`,`perf/of3t_d56renorm/STEP_COST_softmax_c384.json` `perf/of3t_d56renorm/TAPE_CONTROL_0.json`,`perf/of3t_d56renorm/TAPE_CONTROL_1.json` |
...
| `of3t-trajwide` | `0a2b08425` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 1925 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2018 files changed, 2731166 insertions(+), 313 deletions(-).
