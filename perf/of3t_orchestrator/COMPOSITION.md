...
Composed 2026-09-20 08:55:22Z from `origin/main` at `5bc9d1564`.
Head `2b1e1a7ed`, **893 commits ahead**,
carrying **22 of 23 rows**.
...
| `of3t-conditioning` | `8efb9b29b` | `perf/of3t_diffusion/device_gradient.py` |
...
| `of3t-refprec` | `9c037e76f` | `perf/of3t_orchestrator/ADALN_BACKWARD_ELIMINATIONS.json`,`perf/of3t_orchestrator/ADALN_GATE_IS_WHAT_IS_LEFT.json` `perf/of3t_orchestrator/audit_evidence.py`,`perf/of3t_orchestrator/CANCELLATION_REDUCTIONS_UNCONFIGURED.json` `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/CONDITIONING_AMPLIFIES_A_FLOOR_WE_CAN_MOVE.json` `perf/of3t_orchestrator/DISTANCE_TO_GO_BY_MASS.json`,`perf/of3t_orchestrator/K_DOES_NOT_EXPLAIN_THE_MODEL.json` `perf/of3t_orchestrator/NO_SOFTMAX_LEVER_REACHES_THE_BAR.json`,`perf/of3t_orchestrator/ONE_LEAF_IS_THE_DEFECT.json` `perf/of3t_orchestrator/pt/device_gradient_043pt.json`,`perf/of3t_orchestrator/record/DEFECTS.md` `perf/of3t_orchestrator/record/ORCHESTRATOR.md`,`perf/of3t_orchestrator/SOFTMAX_LEVER_DOES_NOT_REACH_THE_BAR.json` `perf/of3t_orchestrator/TWO_MECHANISMS_NOT_ONE.json`,`perf/of3t_reference/bundle_min.py` |
| `of3t-reopen` | `fb6eddd88` | none outside its own `perf/of3t_reopen/` |
| `of3t-softmax` | `655ef3d29` | `tests/test_softmax_precise_site.py`,`tt_bio/openfold3_atom_transformer.py` `tt_bio/openfold3_diffusion_transformer.py`,`tt_bio/protenix.py` `tt_bio/tenstorrent.py` |
| `of3t-tape` | `3aef07969` | none outside its own `perf/of3t_tape/` |
| `of3t-trajectory` | *dispatched, no branch yet* | — |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1544 insertions(+) 148 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 754 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  829 files changed, 631729 insertions(+), 177 deletions(-).
