...
Composed 2026-09-21 05:56:06Z from `origin/main` at `11a92f686`.
Head `b719d8537`, **1743 commits ahead**,
carrying **60 of 61 rows**.
...
| `of3t-condtrans` | `ee601c106` | `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/defecttriage/triage.py` `perf/of3t_orchestrator/difscope/DIFFUSION_SCOPE_AB.json`,`perf/of3t_orchestrator/difscope/scope_ab.py` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` |
...
| `of3t-trajwide` | *dispatched, no branch yet* | — |
...
| campaign artifacts | 1741 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1824 files changed, 2631738 insertions(+), 233 deletions(-).
