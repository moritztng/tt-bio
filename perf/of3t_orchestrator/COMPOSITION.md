...
Composed 2026-09-21 00:22:16Z from `origin/main` at `97baf5025`.
Head `4170efcc9`, **1346 commits ahead**,
carrying **49 of 50 rows**.
...
| `of3t-bondcov` | `73edc3a01` | `perf/of3t_auxheads/bond_coverage.py`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `scripts/of3_port/batch_digest.py`,`scripts/of3_port/build_of3_subset.py` `scripts/of3_port/stage_loss_coverage.py` |
...
| `of3t-f64softmax` | `d69a099ba` | `docs/training.md`,`perf/of3t_diffusion/device_gradient.py` `perf/of3t_softmax/softmax_cost.py`,`tests/test_host_f64_softmax_defaults.py` `tt_bio/openfold3_atom_transformer.py`,`tt_bio/openfold3_diffusion_transformer.py` `tt_bio/protenix.py`,`tt_bio/tenstorrent.py` |
...
| `of3t-wholemodel` | *dispatched, no branch yet* | — |
...
| campaign artifacts | 1547 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1626 files changed, 2308465 insertions(+), 205 deletions(-).
