...
Composed 2026-09-21 12:03:42Z from `origin/main` at `56ad6c0e0`.
Head `adeee64dd`, **1966 commits ahead**,
carrying **68 of 72 rows**.
...
| `of3t-crop768` | *dispatched, no branch yet* | — |
| `of3t-d10-d107` | `98f80057a` | `perf/of3t_d10_d107/d107_score.py`,`perf/of3t_d10_d107/d10_frame_smoke.py` `perf/of3t_d10_d107/d10_rule_vs_upstream.py`,`perf/of3t_d10_d107/d10_terms.py` `perf/of3t_d10_d107/out/D10_FRAME_SMOKE.json`,`perf/of3t_d10_d107/out/D10_RULE.json` `perf/of3t_d10_d107/out/D10_TERMS.json`,`perf/of3t_d10_d107/out/SCORE_never.json` `perf/of3t_d10_d107/out/SCORE_single.json`,`perf/of3t_d10_d107/plstub/pytorch_lightning.py` `perf/of3t_d10_d107/plstub/torchmetrics.py`,`perf/of3t_d10_d107/RUN.sh` `perf/of3t_d10_d107/show.py`,`tt_bio/openfold3_fold.py` `tt_bio/protenix.py`,`tt_bio/worker.py` |
| `of3t-d112` | `a8754b727` | none outside its own `perf/of3t_d112/` |
| `of3t-d116` | `10bf200f9` | `tt_bio/autograd.py`,`tt_bio/taped_ttnn.py` |
| `of3t-d117` | `b09be2a05` | `scripts/of3_dm_step_pcc.py`,`scripts/of3_ref_dm_ttbio_rollout.py` `scripts/of3_refmodel_generic.py`,`scripts/of3_refmodel_on_ttbio_features.py` `scripts/of3_ref_rollout_hybrid.py`,`tt_bio/openfold3_batch.py` |
| `of3t-d122-d115` | `84f8c72a9` | `perf/of3t_orchestrator/audit_evidence.py`,`perf/of3t_orchestrator/charter/CHARTER_EVIDENCE.json` `perf/of3t_orchestrator/charter/charter_evidence.py`,`perf/of3t_orchestrator/charter/charter_is_a_keyword_test.py` `perf/of3t_orchestrator/charter/CHARTER_KEYWORD_TEST.json`,`perf/of3t_orchestrator/charter/STATE_of3t-d122-d115.md` `perf/of3t_orchestrator/status_vocab.py` |
| `of3t-d137-tapegate` | `7f386f768` | `perf/of3t_f64softmax/rowsum_probe.py`,`perf/of3t_orchestrator/assert_new_levers_default_off.py` `perf/of3t_softmax/softmax_cost.py`,`tests/test_host_f64_softmax_defaults.py` `tt_bio/autograd.py`,`tt_bio/ops.py` `tt_bio/tenstorrent.py` |
| `of3t-d1-pairbias` | *dispatched, no branch yet* | — |
| `of3t-d56-renorm` | *dispatched, no branch yet* | — |
...
| `of3t-trajwide` | `6748f81df` | none outside its own `perf/of3t_trajwide/` |
...
|---|---|---|---|
| **engine** | 28 under `tt_bio/`, none vendored | **2415 insertions(+) 217 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1867 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1957 files changed, 2720505 insertions(+), 272 deletions(-).
