...
Composed 2026-09-21 14:39:40Z from `origin/main` at `56ad6c0e0`.
Head `986b588ef`, **2213 commits ahead**,
carrying **75 of 78 rows**.
...
| `of3t-d116-verify` | *dispatched, no branch yet* | — |
...
| `of3t-d137digest` | `fe981fc60` | `.gitignore`,`perf/of3t_d137tapegate/inference_ab_with_aa_floor.py` `perf/of3t_orchestrator/assert_digest_claims_name_their_card.py`,`perf/of3t_orchestrator/compose_verify.sh` `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/defecttriage/triage.py` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `perf/of3t_orchestrator/resolve_d1_pairbias.py`,`perf/of3t_orchestrator/sync_census.py` `perf/of3t_orchestrator/userfacing/CLOSURE_PLAN.json`,`perf/of3t_orchestrator/userfacing/closure_plan.py` |
...
| `of3t-readable-mass` | *dispatched, no branch yet* | — |
...
| `of3t-trajwide` | `0d4876075` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 1949 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2045 files changed, 2862709 insertions(+), 313 deletions(-).
