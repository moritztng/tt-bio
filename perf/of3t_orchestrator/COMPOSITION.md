...
Composed 2026-09-21 15:01:06Z from `origin/main` at `56ad6c0e0`.
Head `06b23f907`, **2264 commits ahead**,
...
| `of3t-crop768` | `dd4403e91` | none outside its own `perf/of3t_crop768/` |
...
| `of3t-trajwide` | `35433c201` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 1975 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2071 files changed, 2896306 insertions(+), 313 deletions(-).
