...
Composed 2026-09-21 09:57:28Z from `origin/main` at `11a92f686`.
Head `c2b55bcde`, **1896 commits ahead**,
...
|---|---|---|---|
| **engine** | 26 under `tt_bio/`, none vendored | **2082 insertions(+) 204 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1804 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1887 files changed, 2692037 insertions(+), 233 deletions(-).
