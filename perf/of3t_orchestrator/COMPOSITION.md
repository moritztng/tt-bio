...
Composed 2026-09-21 04:01:45Z from `origin/main` at `11a92f686`.
Head `d7c1a3241`, **1599 commits ahead**,
carrying **56 of 58 rows**.
...
| `of3t-hostops` | *dispatched, no branch yet* | — |
...
| `of3t-optsem` | *dispatched, no branch yet* | — |
...
| `of3t-rankunify` | `fedee7e53` | `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/defecttriage/triage.py` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `tests/test_of3_sample_ranking.py`,`tests/test_sample_ranking.py` `tt_bio/openfold3_fold.py`,`tt_bio/ranking.py` `tt_bio/rf3/confidence.py`,`tt_bio/worker.py` |
...
|---|---|---|---|
| **engine** | 26 under `tt_bio/`, none vendored | **1973 insertions(+) 198 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1675 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1758 files changed, 2473919 insertions(+), 227 deletions(-).
