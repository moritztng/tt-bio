...
Composed 2026-09-21 13:11:04Z from `origin/main` at `56ad6c0e0`.
Head `abf2b8b55`, **2064 commits ahead**,
carrying **71 of 74 rows**.
...
| `of3t-d10d24-unify` | `fba03051b` | `docs/openfold3-port.md`,`perf/of3t_d10d24unify/negative_control.py` `perf/of3t_d10d24unify/negative_control.txt`,`perf/of3t_d10d24unify/rerank_vs_main.json` `perf/of3t_d10d24unify/rerank_vs_main.py`,`perf/of3t_d10d24unify/rerank_vs_main.txt` `perf/of3t_d10d24unify/served_differs.py`,`perf/of3t_d10d24unify/verify_fold.py` `perf/of3t_d10d24unify/verify_folds.json`,`README.md` `tests/test_ranking_sites.py`,`tt_bio/rf3/confidence.py` |
...
| `of3t-d137ab` | `fe2e31df0` | none outside its own `perf/of3t_d137ab/` |
| `of3t-d137-tapegate` | `46be7a238` | none outside its own `perf/of3t_d137-tapegate/` |
| `of3t-d56-renorm` | `fc3231ef3` | `docs/training.md`,`perf/of3t_d56renorm/BLAST_CONTROL_sitesoff.json` `perf/of3t_d56renorm/BLAST_OPENFOLD3.md`,`perf/of3t_d56renorm/BLAST_RADIUS_noctrl.json` `perf/of3t_d56renorm/BLAST_RADIUS_renorm.json`,`perf/of3t_d56renorm/probe_sitecustomize.py` `perf/of3t_d56renorm/REACH_static.json`,`perf/of3t_d56renorm/renorm_blast_radius.py` `perf/of3t_d56renorm/renorm_reach.py`,`perf/of3t_d56renorm/renorm_step_cost.py` `perf/of3t_d56renorm/renorm_tape_control.py`,`perf/of3t_d56renorm/STEP_COST_softmax_c384.json` `perf/of3t_d56renorm/TAPE_CONTROL_0.json`,`perf/of3t_d56renorm/TAPE_CONTROL_1.json` `perf/of3t_orchestrator/assert_path_order_ratchet.py`,`perf/of3t_orchestrator/compose_verify.sh` `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/defecttriage/triage.py` `tt_bio/autograd.py`,`tt_bio/taped_ttnn.py` |
...
| `of3t-refsweep` | *dispatched, no branch yet* | — |
...
| `of3t-trajwide` | `188ce7f9d` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 1920 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2013 files changed, 2730433 insertions(+), 313 deletions(-).
