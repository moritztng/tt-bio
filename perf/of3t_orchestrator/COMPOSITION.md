...
Composed 2026-09-21 15:33:17Z from `origin/main` at `56ad6c0e0`.
Head `c22c8874e`, **2288 commits ahead**,
...
| `of3t-trajwide` | `ac73fa5b1` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 2011 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2107 files changed, 2907127 insertions(+), 313 deletions(-).
