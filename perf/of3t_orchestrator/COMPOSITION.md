...
Composed 2026-09-20 16:29:42Z from `origin/main` at `1ce777e89`.
Head `eac25cd83`, **1141 commits ahead**,
carrying **37 of 37 rows**.
...
| `of3t-traj20` | `eb55b5386` | none outside its own `perf/of3t_traj20/` |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1617 insertions(+) 156 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1232 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1307 files changed, 1996466 insertions(+), 185 deletions(-).
