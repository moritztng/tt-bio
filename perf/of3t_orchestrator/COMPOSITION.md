...
Composed 2026-09-21 16:56:28Z from `origin/main` at `56ad6c0e0`.
Head `a84d919ee`, **2356 commits ahead**,
carrying **78 of 80 rows**.
...
| `of3t-crop768` | `6573cba4a` | none outside its own `perf/of3t_crop768/` |
...
| `of3t-fwdkcfg` | *dispatched, no branch yet* | — |
...
| `of3t-stepfloor` | `a518037a8` | `perf/of3t_orchestrator/assert_site_flag_defaults.py`,`perf/of3t_orchestrator/assert_timing_is_a_timing_run.py` `perf/of3t_orchestrator/compose_verify.sh`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/defecttriage/triage.py`,`perf/of3t_orchestrator/kwarg_at_site.py` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `perf/of3t_orchestrator/userfacing/CLOSURE_PLAN.json`,`perf/of3t_orchestrator/userfacing/closure_plan.py` |
...
| `of3t-trajwide` | `0dd2652ce` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 2022 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2118 files changed, 2909673 insertions(+), 313 deletions(-).
