...
Composed 2026-09-20 23:12:29Z from `origin/main` at `97baf5025`.
Head `b8d29d158`, **1320 commits ahead**,
carrying **45 of 48 rows**.
...
| `of3t-apbgrad` | *dispatched, no branch yet* | — |
...
| `of3t-bondcov` | `991a957c1` | `perf/of3t_auxheads/bond_coverage.py`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `scripts/of3_port/batch_digest.py`,`scripts/of3_port/build_of3_subset.py` `scripts/of3_port/stage_loss_coverage.py` |
| `of3t-bwdaccum` | `581e10bad` | none outside its own `perf/of3t_bwdaccum/` |
| `of3t-crop512` | *dispatched, no branch yet* | — |
...
| campaign artifacts | 1472 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1550 files changed, 2233394 insertions(+), 205 deletions(-).
