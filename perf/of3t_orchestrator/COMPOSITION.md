...
Composed 2026-09-20 18:18:59Z from `origin/main` at `d5d3c248a`.
Head `ffc64f801`, **1208 commits ahead**,
carrying **40 of 40 rows**.
...
| `of3t-auxheads043` | `8f0632cf2` | `perf/of3t_orchestrator/assert_dispatch_card_token.py`,`perf/of3t_orchestrator/assert_trunk_lever_resolution.py` `perf/of3t_orchestrator/compose_verify.sh`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/D93_IS_QUANTIFIED.json`,`perf/of3t_orchestrator/D93_PREREGISTERED.json` `perf/of3t_orchestrator/of3t-auxheads043.txt`,`perf/of3t_orchestrator/of3t-maskaudit.txt` `perf/of3t_orchestrator/ORIENTATION_IS_SUFFICIENT.json`,`perf/of3t_orchestrator/orientation_is_sufficient.py` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `perf/of3t_orchestrator/record/PROTOCOL.md`,`perf/of3t_orchestrator/REVISION_ARM_PREREGISTERED.json` `perf/of3t_orchestrator/revision/arm_score_padded.json`,`perf/of3t_orchestrator/revision/arm_score_realtokens.json` `perf/of3t_orchestrator/revision/capture_trunk_entry.py`,`perf/of3t_orchestrator/revision/d93_policy.py` `perf/of3t_orchestrator/revision/d93_score.json`,`perf/of3t_orchestrator/revision/mask_check.py` `perf/of3t_orchestrator/revision/run_stack.py`,`perf/of3t_orchestrator/revision/score_masked.py` `perf/of3t_orchestrator/revision/score_revision_arm.py`,`perf/of3t_orchestrator/REVISION_SKEW_BY_SCOPE.json` `perf/of3t_orchestrator/SCORED_AGAINST_THE_RECIPES_OWN_FLOOR.json`,`perf/of3t_orchestrator/THE_ANSWER.json` `perf/of3t_orchestrator/THE_REVISION_ARM_RAN.json`,`perf/of3t_orchestrator/THE_TRUNK_FLAG_IS_MEASURED_AND_BOUNDED.json` `perf/of3t_orchestrator/WHAT_TRUNKFWD_DOES_TO_THE_RETRACTION.json` |
...
| `of3t-softgrad` | `8b6963af8` | `perf/of3t_diffusion/device_gradient.py` |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1709 insertions(+) 174 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1353 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1431 files changed, 2081922 insertions(+), 203 deletions(-).
