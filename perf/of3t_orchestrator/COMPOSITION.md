...
Composed 2026-09-20 23:30:46Z from `origin/main` at `97baf5025`.
Head `073828afe`, **1327 commits ahead**,
carrying **47 of 49 rows**.
...
| `of3t-apbgrad` | `263128e2b` | `tt_bio/taped_ttnn.py` |
...
| `of3t-f64softmax` | *dispatched, no branch yet* | — |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1751 insertions(+) 176 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1502 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1580 files changed, 2252848 insertions(+), 205 deletions(-).
