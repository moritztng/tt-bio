...
Composed 2026-09-19 18:25:35Z from `origin/main` at `72596df4f`.
Head `7cebbbb55`, **262 commits ahead**,
...
| `of3t-gradients` | `265daebc9` | none outside its own `perf/of3t_gradients/` |
| `of3t-pairbias` | `3a0e99d14` | none outside its own `perf/of3t_pairbias/` |
| `of3t-l1` | `0c29fee01` | `tt_bio/autograd.py`,`tt_bio/taped_ttnn.py` |
| `of3t-updaterule` | `337d919d2` | none outside its own `perf/of3t_updaterule/` |
| `of3t-entity` | `b729781c4` | `docs/training.md`,`tests/test_entity_flags.py` `tt_bio/train/objectives.py` |

The third column is what the **collision check** uses: files touched by commits on
