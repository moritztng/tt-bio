...
Composed 2026-09-21 00:03:31Z from `origin/main` at `97baf5025`.
Head `487cee1d2`, **1341 commits ahead**,
carrying **49 of 49 rows**.
...
| `of3t-apbgrad` | `2d5f99182` | `tt_bio/taped_ttnn.py` |
...
| `of3t-f64softmax` | `accf5df02` | `docs/training.md`,`perf/of3t_diffusion/device_gradient.py` `perf/of3t_softmax/softmax_cost.py`,`tests/test_host_f64_softmax_defaults.py` `tt_bio/openfold3_atom_transformer.py`,`tt_bio/openfold3_diffusion_transformer.py` `tt_bio/protenix.py`,`tt_bio/tenstorrent.py` |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1849 insertions(+) 176 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1537 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1616 files changed, 2289029 insertions(+), 205 deletions(-).
