...
Composed 2026-09-20 09:52:58Z from `origin/main` at `da86ffd1a`.
Head `8a6032cb7`, **955 commits ahead**,
carrying **24 of 25 rows**.
...
| `of3t-refprec` | `762722c5a` | none outside its own `perf/of3t_refprec/` |
...
| campaign artifacts | 836 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  911 files changed, 987744 insertions(+), 177 deletions(-).
