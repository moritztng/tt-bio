...
Composed 2026-09-20 11:26:25Z from `origin/main` at `da86ffd1a`.
Head `8b7d6f5ed`, **988 commits ahead**,
...
| campaign artifacts | 916 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  991 files changed, 1333756 insertions(+), 177 deletions(-).
