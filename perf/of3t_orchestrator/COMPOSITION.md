...
Composed 2026-09-20 14:47:45Z from `origin/main` at `7662fc58b`.
Head `96cd49ff2`, **1087 commits ahead**,
carrying **34 of 34 rows**.
...
| `of3t-auxgrad` | `f99b44386` | none outside its own `perf/of3t_auxgrad/` |
...
| `of3t-trunkcliff` | `236af8935` | none outside its own `perf/of3t_trunkcliff/` |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1605 insertions(+) 156 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1073 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1148 files changed, 1354264 insertions(+), 185 deletions(-).
