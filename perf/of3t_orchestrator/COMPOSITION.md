...
Composed 2026-09-20 17:03:51Z from `origin/main` at `1ce777e89`.
Head `8362d0192`, **1161 commits ahead**,
carrying **38 of 38 rows**.
...
| `of3t-wirefix` | `fe693257a` | `perf/of3t_traj20/PREREGISTRATION_WIREFIX.md`,`perf/of3t_traj20/traj20.py` `tests/test_of3_wiring_matches_openfold3.py`,`tests/test_training_dp_launcher.py` `tt_bio/train/optim.py`,`tt_bio/train/recipes.py` |

**Shape of the diff**, because 300-odd files is three very different piles:

| pile | files | lines | what it is |
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1702 insertions(+) 174 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1260 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1337 files changed, 2011786 insertions(+), 203 deletions(-).
