...
Composed 2026-09-21 15:05:59Z from `origin/main` at `56ad6c0e0`.
Head `d6d772d00`, **2270 commits ahead**,
...
| `of3t-trajwide` | `b061e161d` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 1989 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2085 files changed, 2898769 insertions(+), 313 deletions(-).
