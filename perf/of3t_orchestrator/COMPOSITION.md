...
Composed 2026-09-21 04:11:35Z from `origin/main` at `11a92f686`.
Head `26af28ed1`, **1601 commits ahead**,
...
| `of3t-rankunify` | `9509eaeaa` | `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/defecttriage/triage.py` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `tests/test_of3_sample_ranking.py`,`tests/test_sample_ranking.py` `tt_bio/openfold3_fold.py`,`tt_bio/ranking.py` `tt_bio/rf3/confidence.py`,`tt_bio/worker.py` |
...
|---|---|---|---|
| **engine** | 26 under `tt_bio/`, none vendored | **1983 insertions(+) 200 deletions(-)** | the part that changes behaviour |
...
Total  1758 files changed, 2474801 insertions(+), 229 deletions(-).
