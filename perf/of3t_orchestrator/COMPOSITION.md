...
Composed 2026-09-20 23:45:51Z from `origin/main` at `97baf5025`.
Head `67c26b8ad`, **1332 commits ahead**,
carrying **48 of 49 rows**.
...
| `of3t-f64softmax` | `94067ff46` | `tests/test_host_f64_softmax_defaults.py`,`tt_bio/openfold3_atom_transformer.py` `tt_bio/openfold3_diffusion_transformer.py`,`tt_bio/protenix.py` `tt_bio/tenstorrent.py` |
| `of3t-foldab` | `28928ad4f` | none outside its own `perf/of3t_foldab/` |
| `of3t-fp32islands` | *dispatched, no branch yet* | — |
...
|---|---|---|---|
| **engine** | 23 under `tt_bio/`, none vendored | **1845 insertions(+) 176 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1504 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1583 files changed, 2257684 insertions(+), 205 deletions(-).
