...
Composed 2026-09-21 00:37:12Z from `origin/main` at `97baf5025`.
Head `5551bef0d`, **1378 commits ahead**,
carrying **50 of 50 rows**.
...
| `of3t-wholemodel` | `dd4c5dda0` | `perf/of3t_orchestrator/assert_new_levers_default_off.py`,`perf/of3t_orchestrator/bondcov/BOND_COVERAGE_CANDIDATES.md` `perf/of3t_orchestrator/bondcov/BOND_PREDICATE_CANDIDATES.json`,`perf/of3t_orchestrator/bondcov/check_predicate.py` `perf/of3t_orchestrator/bondcov/.gitignore`,`perf/of3t_orchestrator/compose_verify.sh` `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/crop640/CROP_640_768_BYTE_BUDGET.json` `perf/of3t_orchestrator/fp32ceiling/FP32_CEILING_TRIAGE.json`,`perf/of3t_orchestrator/record/DEFECTS.md` `perf/of3t_orchestrator/record/ORCHESTRATOR.md` |
...
| campaign artifacts | 1548 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1627 files changed, 2308604 insertions(+), 205 deletions(-).
