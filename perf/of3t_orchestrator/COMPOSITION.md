...
Composed 2026-09-21 04:25:09Z from `origin/main` at `11a92f686`.
Head `37a25087a`, **1632 commits ahead**,
carrying **57 of 58 rows**.
...
| `of3t-optsem` | `cf83561d9` | `perf/of3t_orchestrator/audit_evidence.py`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/defecttriage/triage.py`,`perf/of3t_orchestrator/record/DEFECTS.md` `perf/of3t_orchestrator/record/ORCHESTRATOR.md`,`tt_bio/train/optim.py` |
...
| `of3t-rankunify` | `9509eaeaa` | none outside its own `perf/of3t_rankunify/` |
...
|---|---|---|---|
| **engine** | 26 under `tt_bio/`, none vendored | **2016 insertions(+) 202 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1691 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1774 files changed, 2479714 insertions(+), 231 deletions(-).
