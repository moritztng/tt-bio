...
Composed 2026-09-19 18:29:35Z from `origin/main` at `72596df4f`.
Head `9372af7d8`, **274 commits ahead**,
carrying **13 of 13 rows**.

| row | branch head | files reachable ONLY from this row |
|---|---|---|
| `of3t-reference` | `399597526` | none outside its own `perf/of3t_reference/` |
...
| `of3t-gradients` | `35c7a108f` | `perf/of3t_orchestrator/audit_evidence.py`,`perf/of3t_orchestrator/compose_verify.sh` `perf/of3t_orchestrator/instrument_d_gpu.sh` |
...
|---|---|---|---|
| **engine** | 19 under `tt_bio/`, none vendored | **1334 insertions(+) 137 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 264 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  332 files changed, 192137 insertions(+), 166 deletions(-).
