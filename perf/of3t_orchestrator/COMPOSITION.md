...
Composed 2026-09-21 11:05:38Z from `origin/main` at `56ad6c0e0`.
Head `d43c33a40`, **1919 commits ahead**,
carrying **62 of 64 rows**.
...
| `of3t-cond043` | `e633d89bf` | `perf/of3t_condtrans/floor_bf16.py`,`perf/of3t_condtrans/run_floor.sh` `perf/of3t_orchestrator/audit_evidence.py`,`perf/of3t_orchestrator/compose_verify.sh` `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/countstable/count_is_not_evaluable_while_drifted.py` `perf/of3t_orchestrator/defecttriage/triage.py`,`perf/of3t_orchestrator/kcfgcensus/census_reduction_config.py` `perf/of3t_orchestrator/kcfgcensus/KCFG_CENSUS_autograd.json`,`perf/of3t_orchestrator/kcfgcensus/KCFG_CENSUS_taped_ttnn.json` `perf/of3t_orchestrator/record/DEFECTS.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` |
...
| `of3t-f64gate` | *dispatched, no branch yet* | — |
...
|---|---|---|---|
| **engine** | 26 under `tt_bio/`, none vendored | **2084 insertions(+) 206 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1805 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1888 files changed, 2692702 insertions(+), 235 deletions(-).
