...
Composed 2026-09-21 13:25:28Z from `origin/main` at `56ad6c0e0`.
Head `f8a5c174d`, **2137 commits ahead**,
carrying **73 of 74 rows**.
...
| `of3t-trajwide` | `40ad2fb4e` | none outside its own `perf/of3t_trajwide/` |
...
|---|---|---|---|
| **engine** | 28 under `tt_bio/`, none vendored | **2585 insertions(+) 252 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1926 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2021 files changed, 2732071 insertions(+), 313 deletions(-).
