...
Composed 2026-09-20 11:32:42Z from `origin/main` at `da86ffd1a`.
Head `6a98aec4f`, **989 commits ahead**,
carrying **27 of 28 rows**.
...
| `of3t-foldab` | *dispatched, no branch yet* | — |
...
| `of3t-residual` | `81564aa81` | `perf/of3t_diffusion/device_gradient.py` |
...
| campaign artifacts | 917 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  992 files changed, 1334076 insertions(+), 177 deletions(-).
