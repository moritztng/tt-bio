...
Composed 2026-09-21 15:38:01Z from `origin/main` at `56ad6c0e0`.
Head `6fa809323`, **2290 commits ahead**,
...
| `of3t-trajwide` | `e919cc348` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 2012 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2108 files changed, 2907354 insertions(+), 313 deletions(-).
