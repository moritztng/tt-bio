...
Composed 2026-09-21 21:07:22Z from `origin/main` at `fd70adde2`.
Head `214364421`, **2590 commits ahead**,
carrying **85 of 88 rows**.
...
| `of3t-covpaths` | `308ca9701` | none outside its own `perf/of3t_covpaths/` |
...
| `of3t-modelboundary` | `7132eb8ce` | `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/record/ORCHESTRATOR.md` `perf/of3t_orchestrator/record/PROTOCOL.md` |
...
| `of3t-trajwide` | `663144aa1` | none outside its own `perf/of3t_trajwide/` |
...
| campaign artifacts | 2210 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2306 files changed, 3157756 insertions(+), 312 deletions(-).
