...
Composed 2026-09-20 08:48:41Z from `origin/main` at `5bc9d1564`.
Head `5297a6167`, **836 commits ahead**,
...
| campaign artifacts | 691 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  762 files changed, 591311 insertions(+), 167 deletions(-).
