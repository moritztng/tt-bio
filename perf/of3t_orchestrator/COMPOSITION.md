...
Composed 2026-09-21 12:31:04Z from `origin/main` at `56ad6c0e0`.
Head `63be03667`, **2016 commits ahead**,
carrying **70 of 71 rows**.
...
|---|---|---|---|
| **engine** | 28 under `tt_bio/`, none vendored | **2545 insertions(+) 252 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1900 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1993 files changed, 2723268 insertions(+), 313 deletions(-).
