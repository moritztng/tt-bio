...
Composed 2026-09-21 12:22:01Z from `origin/main` at `56ad6c0e0`.
Head `3806b5a66`, **2014 commits ahead**,
carrying **69 of 70 rows**.
...
| `of3t-crop768` | `51be36ad8` | `perf/of3t_crop640/split_trace.py`,`tt_bio/autograd.py` `tt_bio/taped_ttnn.py` |
| `of3t-d10-d107` | `1c2c88a2c` | `perf/of3t_d10_d107/frame_cost.py`,`perf/of3t_d10_d107/_hook/sitecustomize.py` `perf/of3t_d10_d107/ligand_fold.py`,`perf/of3t_d10_d107/out/FRAME_COST.json` `perf/of3t_d10_d107/out/LIGAND_FOLD_sb3.json`,`perf/of3t_d10_d107/out/LIGAND_FOLD_zn.json` `perf/of3t_d10_d107/targets/fkbp_sb3.yaml`,`perf/of3t_d10_d107/targets/fkbp_zn.yaml` |
...
| `of3t-d137-tapegate` | `46be7a238` | `perf/clocksample.py`,`perf/of3t_d137tapegate/assert_gate_is_on_the_tape.py` `perf/of3t_d137tapegate/GATE_CALL_COST_pc.json`,`perf/of3t_d137tapegate/gate_call_cost.py` `perf/of3t_d137tapegate/IMPORT_COST_pc.json`,`perf/of3t_d137tapegate/import_cost.py` `perf/of3t_d137tapegate/inference_ab_with_aa_floor.py`,`perf/of3t_f64gate/GATE_CALL_COST_pc.json` `perf/of3t_f64gate/gate_call_cost.py`,`perf/of3t_f64gate/inference_ab_with_aa_floor.py` `perf/of3t_f64softmax/rowsum_probe.py`,`perf/of3t_orchestrator/assert_dispatch_card_token.py` `perf/of3t_orchestrator/assert_new_levers_default_off.py`,`perf/of3t_orchestrator/assert_path_order_ratchet.py` `perf/of3t_orchestrator/compose_verify.sh`,`perf/of3t_orchestrator/COMPOSITION.md` `perf/of3t_orchestrator/defecttriage/triage.py`,`perf/of3t_orchestrator/record/DEFECTS.md` `perf/of3t_orchestrator/record/ORCHESTRATOR.md`,`perf/of3t_orchestrator/record/PROTOCOL.md` `perf/of3t_orchestrator/resolve_d116_softmax_inner.py`,`perf/of3t_softmax/softmax_cost.py` `tests/test_host_f64_softmax_defaults.py`,`tt_bio/autograd.py` `tt_bio/ops.py`,`tt_bio/tenstorrent.py` |
...
| `of3t-trajwide` | `0bf3b118d` | none outside its own `perf/of3t_trajwide/` |
...
|---|---|---|---|
| **engine** | 28 under `tt_bio/`, none vendored | **2542 insertions(+) 252 deletions(-)** | the part that changes behaviour |
| vendored upstream | 33 under `tt_bio/_vendor/openfold3/` | 15198 insertions(+) 18 deletions(-) | their pipeline, carried in |
| campaign artifacts | 1891 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  1982 files changed, 2722370 insertions(+), 308 deletions(-).
