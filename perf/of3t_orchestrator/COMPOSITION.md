...
Composed 2026-09-20 10:07:56Z from `origin/main` at `da86ffd1a`.
Head `e6c017c5c`, **959 commits ahead**,
carrying **24 of 26 rows**.
...
| `of3t-direct` | `7517fe116` | `perf/of3t_auxheads/aux_instrument.py`,`perf/of3t_auxheads/msa_instrument.py` `perf/of3t_conditioning/device_cond_gradient.py`,`perf/of3t_trajectory/agreement.py` |
| `of3t-pairformer` | *dispatched, no branch yet* | — |
| `of3t-refprec` | `e9e9ea192` | none outside its own `perf/of3t_refprec/` |
| `of3t-residual` | *dispatched, no branch yet* | — |
...
| campaign artifacts | 842 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  917 files changed, 1036788 insertions(+), 177 deletions(-).
