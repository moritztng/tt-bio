...
Composed 2026-09-21 12:52:37Z from `origin/main` at `56ad6c0e0`.
Head `8310e8d86`, **2058 commits ahead**,
carrying **71 of 73 rows**.
...
| `of3t-d137ab` | *dispatched, no branch yet* | — |
| `of3t-d137-tapegate` | `46be7a238` | none outside its own `perf/of3t_d137-tapegate/` |
| `of3t-d56-renorm` | `25915aba8` | `docs/training.md`,`perf/of3t_d56renorm/BLAST_OPENFOLD3.md` `perf/of3t_d56renorm/BLAST_RADIUS_noctrl.json`,`perf/of3t_d56renorm/probe_sitecustomize.py` `perf/of3t_d56renorm/REACH_static.json`,`perf/of3t_d56renorm/renorm_blast_radius.py` `perf/of3t_d56renorm/renorm_reach.py`,`perf/of3t_d56renorm/renorm_step_cost.py` `perf/of3t_d56renorm/renorm_tape_control.py`,`perf/of3t_d56renorm/STEP_COST_softmax_c384.json` `perf/of3t_d56renorm/TAPE_CONTROL_0.json`,`perf/of3t_d56renorm/TAPE_CONTROL_1.json` `perf/of3t_orchestrator/assert_path_order_ratchet.py`,`perf/of3t_orchestrator/compose_verify.sh` `perf/of3t_orchestrator/COMPOSITION.md`,`perf/of3t_orchestrator/defecttriage/triage.py` `tt_bio/autograd.py`,`tt_bio/taped_ttnn.py` |
...
| campaign artifacts | 1915 under `perf/of3t_*/` | the bulk | measurements and instruments |

Total  2008 files changed, 2729682 insertions(+), 313 deletions(-).
