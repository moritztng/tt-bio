...
# attaching to it.
#
# TAG matches launch_profile.sh's, so a watcher follows one tree's arm and not another's.
set -u
...
PY
  ...
  # tt_* attributes live on the class node, not under .../device/
