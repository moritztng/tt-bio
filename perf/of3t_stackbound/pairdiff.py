#!/usr/bin/env python3
"""of3t-stackbound: of3t-stackexact pairdiff.py with this row's arm reports added to the lookup. Two trunk arms against each other, in one metric, so a floor and a separation sit side by side.
...
ARM_REPORTS = ("perf/of3t_stackbound/DEV_*.json", "perf/of3t_stackbound/x5/DEV_*.json", "perf/of3t_stackexact/DEV_*.json", "perf/of3t_modelever/DEV_*.json", "perf/of3t_recut/DEV_RENORM_MODEL_N384_*.json")
