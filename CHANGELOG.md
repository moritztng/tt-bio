...
- `tt-bio affinity DATA` predicts protein-ligand binding affinity without folding anything.
  ...
  H200. One prediction costs 6.5 s at 512 aa on one Blackhole card against 386 s for Boltz-2
  affinity, which is what tt-bio shipped for this question before; against a GPU it is 6.2x
