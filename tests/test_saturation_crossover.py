...
Runnable two ways: as a script (`python tests/test_saturation_crossover.py`, exits
non-zero on failure) and under pytest (one test, same checks).
"""
...
def test_crossover_block_on_known_curves():
    run_checks()
