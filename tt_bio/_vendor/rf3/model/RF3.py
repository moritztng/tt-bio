...
from tt_bio._vendor.rf3.diffusion_samplers.inference_sampler import (
    SampleDiffusion,
    SamplePartialDiffusion,
)
from tt_bio._vendor.rf3.model.layers.pairformer_layers import (
    FeatureInitializer,
)
from tt_bio._vendor.rf3.model.RF3_structure import DiffusionModule, DistogramHead, Recycler
from torch import nn

from tt_bio._vendor.foundry.training.checkpoint import create_custom_forward
from tt_bio._vendor.foundry.utils.torch import device_of
...
class RF3WithConfidence(RF3):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        # (Lazy import)
        from tt_bio._vendor.rf3.model.layers.af3_auxiliary_heads import ConfidenceHead  # noqa
