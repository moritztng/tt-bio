import torch
from tt_bio._vendor.rf3.data.ground_truth_template import (
    af3_noise_scale_to_noise_level,
)
from tt_bio._vendor.rf3.model.layers.af3_diffusion_transformer import AtomTransformer
from tt_bio._vendor.rf3.model.layers.attention import TriangleAttention, TriangleMultiplication
from tt_bio._vendor.rf3.model.layers.layer_utils import (
    MultiDimLinear,
    Transition,
    collapse,
...
from tt_bio._vendor.rf3.model.layers.mlff import ConformerEmbeddingWeightedAverage
from tt_bio._vendor.rf3.model.layers.outer_product import (
    OuterProductMean_AF3,
)
from tt_bio._vendor.rf3.model.RF3_blocks import MSAPairWeightedAverage, MSASubsampleEmbedder
from torch import nn
from torch.nn.functional import one_hot, relu

from tt_bio._vendor.foundry.model.layers.blocks import Dropout
from tt_bio._vendor.foundry.training.checkpoint import activation_checkpointing
from tt_bio._vendor.foundry.utils.torch import scatter_mean
