...
def patch_conformer_fallback_to_input_coords() -> None:
    ...
    """
    import tt_bio._vendor.atomworks.ml.transforms.af3_reference_molecule as _af3_ref
    import tt_bio._vendor.atomworks.ml.transforms.rdkit_utils as _rdkit_utils
