...
# Vendored inference-only stubs: gradient checkpointing / chunked attention are
# training-only paths the ABodyBuilder3 structure module never invokes at
# inference. Defined as no-ops so this file imports without the upstream
# checkpointing/chunk_utils modules.
def get_checkpoint_fn():
    def _identity(fn, *args, **kwargs):
        return fn(*args, **kwargs)
    return _identity


def _chunk_slice(t, *args, **kwargs):
    return t


from tt_bio._vendor.abodybuilder3.openfold.utils.precision_utils import is_fp16_enabled
