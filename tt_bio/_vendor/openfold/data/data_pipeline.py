...
import numpy as np
import torch
from tt_bio._vendor.openfold.data import (
    templates,
    parsers,
    mmcif_parsing,
    msa_identifiers,
...
from tt_bio._vendor.openfold.data.templates import (
    get_custom_template_features,
    empty_template_feats,
    CustomHitFeaturizer,
)
from tt_bio._vendor.openfold.data.tools import jackhmmer, hhblits, hhsearch, hmmsearch
from tt_bio._vendor.openfold.np import residue_constants, protein
