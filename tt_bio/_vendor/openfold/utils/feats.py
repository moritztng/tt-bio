...
from tt_bio._vendor.openfold.np import protein
import tt_bio._vendor.openfold.np.residue_constants as rc
from tt_bio._vendor.openfold.utils.geometry import rigid_matrix_vector, rotation_matrix, vector
