...
def _add_query_mask_idxs_methods() -> None:
    ...
    from tt_bio._vendor.atomworks.io.utils.query import query, mask, idxs
...
def _enable_segment_slices_in_atom_arrays() -> None:
    ...
    from tt_bio._vendor.atomworks.io.utils.selection import SegmentSlice
...
def _update_get_residue_starts() -> None:
    ...
    from tt_bio._vendor.atomworks.io.utils.selection import get_residue_starts  # noqa: E402
