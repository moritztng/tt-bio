...
from tt_bio._vendor.atomworks.common import KeyToIntMapper, exists
...
from tt_bio._vendor.atomworks.enums import ChainType, ChainTypeInfo
from tt_bio._vendor.atomworks.io import parse
from tt_bio._vendor.atomworks.io.parser import STANDARD_PARSER_ARGS
from tt_bio._vendor.atomworks.io.template import build_template_atom_array
from tt_bio._vendor.atomworks.io.tools.fasta import one_letter_to_ccd_code, split_generalized_fasta_sequence
from tt_bio._vendor.atomworks.io.utils.bonds import (
...
from tt_bio._vendor.atomworks.io.utils.ccd import (
...
from tt_bio._vendor.atomworks.io.utils.io_utils import CIF_LIKE_EXTENSIONS, read_any
...
def smiles_to_annotated_atom_array(
    ...
    *,
    ...
    if backend == "rdkit":
        from tt_bio._vendor.atomworks.io.tools.rdkit import atom_array_from_rdkit, smiles_to_rdkit
...
def sdf_to_annotated_atom_array(
    ...
    *,
    ...
    if backend == "rdkit":
        from tt_bio._vendor.atomworks.io.tools.rdkit import atom_array_from_rdkit, sdf_to_rdkit
