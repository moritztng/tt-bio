...
import tt_bio._vendor.atomworks.io.transforms.atom_array as ta
from tt_bio._vendor.atomworks.common import exists, string_to_md5_hash
from tt_bio._vendor.atomworks.constants import CCD_MIRROR_PATH, CRYSTALLIZATION_AIDS, WATER_LIKE_CCDS
from tt_bio._vendor.atomworks.io import template
from tt_bio._vendor.atomworks.io.transforms.categories import (
    category_to_dict,
...
from tt_bio._vendor.atomworks.io.utils.assembly import build_assemblies_from_asym_unit
from tt_bio._vendor.atomworks.io.utils.atom_array_plus import AtomArrayPlus, AtomArrayPlusStack, stack_any
from tt_bio._vendor.atomworks.io.utils.bonds import get_struct_conn_dict_from_atom_array
from tt_bio._vendor.atomworks.io.utils.ccd import check_ccd_codes_are_available
from tt_bio._vendor.atomworks.io.utils.chain import create_chain_id_generator
from tt_bio._vendor.atomworks.io.utils.io_utils import (
...
from tt_bio._vendor.atomworks.io.utils.non_rcsb import (
...
def _get_atomworks_version() -> str:
    ...
    try:
        from tt_bio._vendor.atomworks import __version__
