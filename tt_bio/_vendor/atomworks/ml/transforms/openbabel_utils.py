...
from tt_bio._vendor.atomworks.constants import ATOMIC_NUMBER_TO_ELEMENT, ELEMENT_NAME_TO_ATOMIC_NUMBER, UNKNOWN_LIGAND
...
def atom_array_to_openbabel(
    ...
    Example:
        .. code-block:: python
            ...
            import numpy as np
            from tt_bio._vendor.atomworks.ml.transforms.openbabel_utils import atom_array_to_openbabel
