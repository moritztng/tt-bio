...
from tt_bio._vendor.openfold3.core.data.framework.data_module import DatasetMode, DatasetSpec
...
class DefaultDatasetConfigSection(BaseModel):
    ...
    Datasets for this project are defined in
      `tt_bio._vendor.openfold3.core.data.framework.single_datasets`
