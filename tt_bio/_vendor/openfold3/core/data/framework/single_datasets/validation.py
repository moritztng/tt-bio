...
from tt_bio._vendor.openfold3.core.data.framework.single_datasets.base_of3 import (
    BaseOF3Dataset,
)
...
from tt_bio._vendor.openfold3.core.data.resources.lists import (
    AB_AG_CHAIN_PAIR_TYPES,
    AB_AG_CHAIN_TYPES,
)
from tt_bio._vendor.openfold3.core.utils.atomize_utils import broadcast_token_feat_to_atoms
