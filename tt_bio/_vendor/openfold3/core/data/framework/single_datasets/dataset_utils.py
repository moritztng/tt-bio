...
from tt_bio._vendor.openfold3.core.data.framework.data_module import openfold_batch_collator
from tt_bio._vendor.openfold3.core.utils.atomize_utils import broadcast_token_feat_to_atoms
from tt_bio._vendor.openfold3.core.utils.logging_utils import suppress_warnings
from tt_bio._vendor.openfold3.core.utils.permutation_alignment import (
...
def check_invalid_feature_dict(features: dict):
    ...
    with suppress_warnings(
        logger_name="tt_bio._vendor.openfold3.core.utils.geometry.kabsch_alignment"
    ):
        multi_chain_permutation_alignment(
            batch=feats_perm,
