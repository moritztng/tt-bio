...
from tt_bio._vendor.openfold3.core.data.primitives.featurization.structure import encode_one_hot
from tt_bio._vendor.openfold3.core.data.primitives.structure.template import TemplateSliceCollection
from tt_bio._vendor.openfold3.core.data.resources.residues import (
    STANDARD_RESIDUES_WITH_GAP_3,
    get_with_unknown_3_to_idx,
)
from tt_bio._vendor.openfold3.core.utils.all_atom_multimer import make_transform_from_reference
from tt_bio._vendor.openfold3.core.utils.geometry.vector import Vec3Array
