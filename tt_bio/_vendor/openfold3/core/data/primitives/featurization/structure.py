...
from tt_bio._vendor.openfold3.core.data.primitives.structure.cleanup import filter_fully_atomized_bonds
from tt_bio._vendor.openfold3.core.data.primitives.structure.labels import get_token_starts
