...
from tt_bio._vendor.openfold3.core.data.primitives.caches.lmdb import LMDBDict, LMDBEnv
...
class PreprocessingDataCache:
    ...
    def to_json(self, file: Path) -> None:
        ...
        from tt_bio._vendor.openfold3.core.data.io.dataset_cache import write_datacache_to_json
...
class DatasetCache:
    ...
    def to_lmdb(
        ...
        """
        from tt_bio._vendor.openfold3.core.data.primitives.caches.lmdb import (
