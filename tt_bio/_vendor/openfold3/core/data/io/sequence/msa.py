...
from tt_bio._vendor.openfold3.core.config.config_utils import DirectoryPathOrNone
...
from tt_bio._vendor.openfold3.core.data.io.sequence.fasta import parse_fasta
