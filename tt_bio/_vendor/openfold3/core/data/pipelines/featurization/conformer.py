...
from tt_bio._vendor.openfold3.core.data.primitives.structure.component import PERIODIC_TABLE
from tt_bio._vendor.openfold3.core.model.structure.augmentation import centre_random_augmentation
