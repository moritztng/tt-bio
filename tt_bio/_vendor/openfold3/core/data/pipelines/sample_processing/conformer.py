...
from tt_bio._vendor.openfold3.core.data.io.structure.mol import read_single_annotated_sdf
from tt_bio._vendor.openfold3.core.data.primitives.caches.format import (
    DatasetChainData,
