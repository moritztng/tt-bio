...
from tt_bio._vendor.openfold3.core.data.io.structure.cif import parse_target_structure
from tt_bio._vendor.openfold3.core.data.primitives.caches.format import PreprocessingChainData
...
from tt_bio._vendor.openfold3.core.data.primitives.structure.cropping import (
