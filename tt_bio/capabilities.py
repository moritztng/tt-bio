...
CAPABILITY: dict[str, dict[str, str]] = {
    ...
    "esmfold2": _row(protein_free=REFUSED, templates=REFUSED, pocket=REFUSED, affinity=NOTED),
    "esmfold2-fast": _row(protein_free=REFUSED, templates=REFUSED, pocket=REFUSED,
                          affinity=NOTED),
