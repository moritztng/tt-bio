...
from tt_bio.boltzgen.data.featurizer import Featurizer, global_stream_rng
...
from tt_bio.boltzgen.data.template import load_dummy_templates
from tt_bio.boltzgen.data.tokenizer import Tokenizer
from tt_bio.boltzgen.data.data import Input
from tt_bio.boltzgen.data.selector import ProteinSelector
...
class FromYamlDataModule:
    """DataModule for BoltzGen."""

    def __init__(
        self, cfg: DataConfig, batch_size, num_workers, pin_memory=False, extra_features=None
    ) -> None:
