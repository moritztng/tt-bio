...
from tt_bio.boltzgen.data.data import Input, Structure, Record, MSA
...
from tt_bio.boltzgen.task.predict.loading_utils import load_record, load_structure
