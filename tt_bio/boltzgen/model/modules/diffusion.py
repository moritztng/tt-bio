...
# replaced by ``TTScoreModelAdapter`` (see :mod:`tt_bio.boltzgen.adapter`).
...
from tt_bio.boltzgen.model.modules.utils import (
    center,
...
class AtomDiffusion(Module):
    def __init__(
        ...
        # of design / folding. TTScoreModelAdapter wraps tt-bio's
        # TTDiffusionModule with BoltzGen's kwarg+dict calling convention.
        from tt_bio.boltzgen.adapter import TTScoreModelAdapter
