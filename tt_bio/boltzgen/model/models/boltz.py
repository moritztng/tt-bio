...
from tt_bio.boltzgen.progress import progress as _emit_progress
import tt_bio.boltzgen.model.layers.initialize as init
from tt_bio.data import const
from tt_bio.boltzgen.model.modules.confidence import ConfidenceModule
from tt_bio.boltzgen.model.modules.diffusion import AtomDiffusion
from tt_bio.boltzgen.model.modules.diffusion_conditioning import (
    DiffusionConditioning,
)
from tt_bio.boltzgen.model.modules.encoders import RelativePositionEncoder
from tt_bio.boltzgen.model.modules.affinity import AffinityModule
from tt_bio.boltzgen.model.modules.masker import BoltzMasker
from tt_bio.boltzgen.model.modules.trunk import (
    BFactorModule,
    ContactConditioning,
    DistogramModule,
    InputEmbedder,
...
from tt_bio.boltzgen.model.modules.inverse_fold import (
...
class Boltz(nn.Module):
    ...
    def load_checkpoint_weights(self, checkpoint_path):
        ...
        from tt_bio.boltzgen.adapter import (
