"""Two calling-convention adapters around tt-bio's ttnn modules.

Each adapter subclasses a tt-bio ttnn module and only rewrites
...
def load_boltz_checkpoint(
    ...
    **constructor_overrides,
    ...
    """
    from tt_bio.boltzgen.model.models.boltz import Boltz
