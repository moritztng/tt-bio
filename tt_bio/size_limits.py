    ...
    "protenix-v2": {
        "wormhole_b0": Ceiling(
            ...
            evidence="walked 2026-09-23 on origin/main cec7979b1 (pair-residency merged), "
                     ...
                     "1408 in 1881.7 s (card 3) and 1536 in 2046.8 s (card 9), AICLK median 1000 MHz "
                     "sampled during every fold, at host load 52-214 on 64 cores. Nothing above "
                     "1536 has run to an outcome yet. The earlier row "
