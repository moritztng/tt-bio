...
def _device_conditioning() -> bool:
    ...
    #
    # ON by default since 2026-09-12, on the control it owed. cdk2x2_512 per pseudo-domain
    # 0.3947 / 0.3304 A against a 0.60 A bar, cdk2x2_298 monomer 0.3938 A, CA-lDDT 0.99341 against
    # base and native CA-lDDT against 1HCL up on both copies. 1.04642x on the 512 aa fold
    # (19.658 -> 18.786 s, qb2 card 1 Blackhole, benchlock, interleaved, A/A floor 1.00899x).
    # state/b2z2-bh-union-clean.md.
