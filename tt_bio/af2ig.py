...
from tt_bio.af2ig_input import (DEFAULT_BINDER_CHAIN, DEFAULT_TARGET_CHAIN,  # noqa: F401
                                AF2IGInput, read_af2ig_input)
...
def features(spec: AF2IGInput) -> dict[str, np.ndarray]:
    ...
    with tempfile.TemporaryDirectory(prefix="af2ig-") as tmp:
        ...
        pdb.write_text(to_pdb_text(spec.structure))
        try:
