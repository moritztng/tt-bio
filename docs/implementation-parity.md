...
| Boltz-2 | 9NCY AbAg complex (3 chains, 505 tokens), no MSA | PASS (envelope gate) | shared-draws envelope: CA-RMSD numerator 0.760 Å vs bound 2.539 Å (ratio 0.46); first leg inside the former [385,506]aa L1 crash band (fixed by c06bd76cf); campaign-relevant size (AbAg-XM median 509) |
