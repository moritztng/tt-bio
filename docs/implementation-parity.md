...
Net: 33 PASS, 6 PASS-caveated, 2 GAP-evidenced (boltz2-9ncy-nomsa, root-caused below; af2ig-trunk-device, a measured bfloat16 floor the leg gates as such). Recounted from the table above, which two separate additions had left at 28. The three Boltz-2 affinity
