...
engine is expected to reach — the same chip returns 21.5 PXDesign designs/h (8 per job) and
5.1 RFdiffusion3 designs/h (2 per job). Both hold at that size with several designs in one
job; PXDesign refuses past about 1664 tokens of target plus binder, naming the allocation.
