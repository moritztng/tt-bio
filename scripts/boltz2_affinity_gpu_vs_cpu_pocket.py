...
FIX = Path("docs/implementation-parity-data/ref-fixtures/boltz2")
TARGETS = {
    "affinity_fkg": "fkbp12",
    "affinity_dhfr": "dhfr",
    "affinity_tryp": "tryp",
...
def main() -> int:
    ...
    ap.add_argument("--out", default="docs/implementation-parity-data/boltz2-affinity-gpu-vs-cpu-pocket.json")
