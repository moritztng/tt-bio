#!/usr/bin/env python3
"""Capture the reference foundry featurizer's `f` for a fully-unconditional
symmetric design spec (no `input` PDB at all -- e.g. uncond_C5/uncond_D4 from
the real docs/examples/symmetry.md). Same pipeline config as capture_ref_f_spec.py."""
...
def main():
    ...
    ap.add_argument("--spec_json", required=True, help="path to JSON spec dict")
