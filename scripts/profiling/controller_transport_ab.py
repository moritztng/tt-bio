...
Measured on the JapanFold galaxy, A/B/A/B:

    base64-in-JSON-in-SQLite   9.72 s of controller work, SQLite +925 MB per run
    path handback              0.49 s, SQLite +0.1 MB          -> ~20x less controller work
...
def main() -> int:
    ...
    from tt_bio.distributed import ControllerStore
