...
def main(argv):
    ...
    if "256->512" not in new_pairs and any(r == "512" for r in new_rungs):
        print("  WARNING: a 512 rung exists but no 256->512 gain pair was emitted."
              " Run n512_power_census.py -- a rung under POWER_MIN=50 complete targets"
              " is dropped from the stop-rule chain silently.")
