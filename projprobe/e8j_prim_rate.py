...
PRIMS = (
    ...
    (8, "trunc_tile_sfpu"),
    (9, "frac_tile_sfpu"),
    (10, "mul_binary_tile_sfpu"),
    (11, "add_binary_tile_sfpu"),
    (12, "sub_binary_tile_sfpu"),
    (13, "reduce_sum_col_fp32acc"),
    (14, "unary_bcast_row"),
    (15, "unary_bcast_col"),
)

# E8g: only the SFPU holds fp32, and only with unpack_to_dest. The SFPU arms therefore have to be
# timed in the configuration they will actually run in, since the knob changes the unpack path.
SFPU_PRIMS = (8, 9, 10, 11, 12, 14, 15)
...
def main():
    ...
    (HERE / "e8j_prim_rate.json").write_text(json.dumps(res, indent=1))
